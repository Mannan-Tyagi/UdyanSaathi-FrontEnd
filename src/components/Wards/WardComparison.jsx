    ...
    return (
      <div className="min-h-screen bg-canvas page-gradient">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8">
            <div className="h-10 w-64 bg-mist rounded-card animate-pulse mb-4"></div>
            <div className="h-6 w-96 bg-mist rounded-card animate-pulse"></div>
          </div>
    ...
    return (
      <div className="min-h-screen bg-canvas page-gradient">
        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          <div className="text-center bento-card p-8 max-w-md border-status-danger/30">
            <div className="w-16 h-16 mx-auto mb-4 bg-status-danger/20 rounded-full flex items-center justify-center">
            ...
            <p className="text-metal mb-4">{error}</p>
            <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {filteredWards.length === 0 && (
                <div className="col-span-full text-center py-12 bento-card">
                  ...
                  <p className="text-metal">No wards match your filters</p>
                </div>
              )}
            </div>
          </div>
                    ...
                    {detailsLoading ? (
                      ...
                      <>
                        ...
                        <div className="flex items-center justify-between p-3 bg-canvas rounded-lg">
                          <span className="text-metal text-sm">Data Source</span>
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                            wardDetails.data_type?.includes('Live') ? 'bg-status-safe/10 text-status-safe' : 'bg-primary/10 text-primary'
                          }`}>
                        ...
                        {/* Health Impact Cards */}
                        <div>
                          <h3 className="text-lg font-semibold text-ink mb-3">🏥 Health Impact Analysis</h3>
                          <div className="grid grid-cols-2 gap-4">
                            <div className="bg-orange-50 border border-orange-200 rounded-card p-4">
                              <div className="flex items-center gap-2 mb-2">
                                <span className="text-2xl">🚬</span>
                                <span className="text-orange-600 text-sm">Cigarette Equivalent</span>
                              </div>
                              <p className="text-2xl font-bold text-ink">{wardDetails.cigarettes_equivalent}</p>
                              <p className="text-xs text-metal">cigarettes/day breathed</p>
                            </div>
                            
                            <div className="bg-purple-50 border border-purple-200 rounded-card p-4">
                              <div className="flex items-center gap-2 mb-2">
                                <span className="text-2xl">🫁</span>
                                <span className="text-purple-600 text-sm">Lung Age Impact</span>
                              </div>
                              <p className="text-2xl font-bold text-ink">+{wardDetails.lung_age_increase}</p>
                              <p className="text-xs text-metal">years added to lung age</p>
                            </div>
                            
                            <div className="bg-red-50 border border-red-200 rounded-card p-4">
                              <div className="flex items-center gap-2 mb-2">
                                <span className="text-2xl">🏥</span>
                                <span className="text-red-600 text-sm">Hospital Visit Risk</span>
                              </div>
                              <p className="text-2xl font-bold text-ink">{wardDetails.hospital_visit_risk}%</p>
                              <p className="text-xs text-metal">increased probability</p>
                            </div>
                            
                            <div className="bg-blue-50 border border-blue-200 rounded-card p-4">
                              <div className="flex items-center gap-2 mb-2">
                                <span className="text-2xl">❤️</span>
                                <span className="text-blue-600 text-sm">Life Expectancy</span>
                              </div>
                              <p className="text-2xl font-bold text-ink">-{wardDetails.life_expectancy_impact}</p>
                              <p className="text-xs text-metal">years reduction</p>
                            </div>

                            <div className="bg-pink-50 border border-pink-200 rounded-card p-4">
                              <div className="flex items-center gap-2 mb-2">
                                <span className="text-2xl">💔</span>
                                <span className="text-pink-600 text-sm">Cardiovascular Risk</span>
                              </div>
                              <p className="text-2xl font-bold text-ink">{wardDetails.cardiovascular_risk}%</p>
                              <p className="text-xs text-metal">elevated heart risk</p>
                            </div>

                            <div className="bg-cyan-50 border border-cyan-200 rounded-card p-4">
                              <div className="flex items-center gap-2 mb-2">
                                <span className="text-2xl">🌬️</span>
                                <span className="text-cyan-600 text-sm">Respiratory Risk</span>
                              </div>
                              <p className="text-2xl font-bold text-ink">{wardDetails.respiratory_risk}%</p>
                              <p className="text-xs text-metal">breathing issues risk</p>
                            </div>
                          </div>
                        </div>
                        ...
                        {wardDetails.disease_burden && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">📊 Annual Disease Burden (Estimated)</h3>
                            <div className="grid grid-cols-3 gap-2">
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Premature Deaths</p>
                                <p className="text-lg font-bold text-status-danger">{wardDetails.disease_burden.premature_deaths_annual}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Respiratory Cases</p>
                                <p className="text-lg font-bold text-status-warning">{wardDetails.disease_burden.respiratory_cases}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Heart Cases</p>
                                <p className="text-lg font-bold text-pink-500">{wardDetails.disease_burden.cardiovascular_cases}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Asthma Attacks</p>
                                <p className="text-lg font-bold text-yellow-500">{wardDetails.disease_burden.asthma_attacks}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">ICU Admissions</p>
                                <p className="text-lg font-bold text-purple-500">{wardDetails.disease_burden.icu_admissions}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Population</p>
                                <p className="text-lg font-bold text-primary">{(wardDetails.population?.total / 1000).toFixed(0)}K</p>
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {wardDetails.pollutants && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">🔬 Pollutant Analysis</h3>
                            <div className="space-y-2">
                              {Object.entries(wardDetails.pollutants).map(([key, data]) => (
                                <div key={key} className="bg-canvas rounded-lg p-3">
                                  <div className="flex items-center justify-between mb-1">
                                    <span className="text-ink font-medium">{data.limit?.name || key.toUpperCase()}</span>
                                    <div className="flex items-center gap-2">
                                      <span className="text-xl font-bold text-ink">{data.value}</span>
                                      <span className="text-xs text-metal">{data.limit?.unit}</span>
                                    </div>
                                  </div>
                                  <div className="flex items-center justify-between">
                                    ...
                                    {data.exceedance > 0 && (
                                      <span className="text-xs text-status-danger">{data.exceedance}% above safe limit</span>
                                    )}
                                  </div>
                                  {data.limit?.effect && (
                                    <p className="text-xs text-metal mt-1">{data.limit.effect}</p>
                                  )}
                                </div>
                              ))}
                            </div>
                        ...
                        {wardDetails.pollution_sources && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">🏭 Pollution Sources</h3>
                            <div className="space-y-2">
                              {Object.entries(wardDetails.pollution_sources).map(([source, percentage]) => (
                                <div key={source} className="bg-canvas rounded-lg p-2">
                                  <div className="flex items-center justify-between mb-1">
                                    <span className="text-ink capitalize text-sm">{source.replace('_', ' ')}</span>
                                    <span className="text-ink font-medium">{percentage}%</span>
                                  </div>
                        ...
                        {wardDetails.economic_impact && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">💰 Economic Impact</h3>
                            <div className="grid grid-cols-2 gap-2">
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Healthcare Cost</p>
                                <p className="text-lg font-bold text-status-danger">₹{wardDetails.economic_impact.healthcare_cost_lakhs}L</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Productivity Loss</p>
                                <p className="text-lg font-bold text-status-warning">₹{wardDetails.economic_impact.productivity_loss_lakhs}L</p>
                              </div>
                              <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-orange-200 rounded-lg p-3 text-center col-span-2">
                                <p className="text-xs text-metal">Total Annual Cost</p>
                                <p className="text-2xl font-bold text-ink">₹{wardDetails.economic_impact.total_cost_lakhs} Lakhs</p>
                                <p className="text-xs text-metal">₹{wardDetails.economic_impact.cost_per_person}/person</p>
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {wardDetails.vulnerable_groups && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">👥 Vulnerable Groups at Risk</h3>
                            <div className="space-y-3">
                              {wardDetails.vulnerable_groups.map((group, idx) => (
                                <div key={idx} className="bg-canvas rounded-lg p-3">
                                  <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                      <span className="text-xl">{group.icon}</span>
                                      <span className="text-ink font-medium">{group.group}</span>
                                    </div>
                                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                                      group.risk_level === 'Critical' ? 'bg-red-100 text-red-700' :
                                      group.risk_level === 'Very High' ? 'bg-red-50 text-red-600' :
                                      group.risk_level === 'High' ? 'bg-orange-100 text-orange-700' :
                                  ...
                                  <div className="flex justify-between text-sm mb-1">
                                    <span className="text-metal">Affected Population:</span>
                                    <span className="text-ink font-medium">{group.count?.toLocaleString()}</span>
                                  </div>
                                  {group.specific_impact && (
                                    <p className="text-xs text-status-danger mb-1">⚠️ {group.specific_impact}</p>
                                  )}
                                  <p className="text-xs text-status-safe">✅ {group.recommendation}</p>
                                </div>
                              ))}
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">😷 Mask</p>
                                <p className="text-sm font-medium text-ink">{wardDetails.mask_recommendation.type}</p>
                                <p className="text-xs text-metal">{wardDetails.mask_recommendation.rating}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">🏃 Outdoor Score</p>
                                <p className="text-sm font-medium text-ink">{wardDetails.outdoor_activity_score}/100</p>
                                <p className="text-xs text-metal">{wardDetails.outdoor_activity_score > 60 ? 'Safe' : wardDetails.outdoor_activity_score > 30 ? 'Caution' : 'Avoid'}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 col-span-2">
                                <p className="text-xs text-metal mb-1">⏰ Best Time for Outdoor</p>
                                <p className="text-sm font-medium text-ink">{wardDetails.best_outdoor_time}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">💨 Air Purifier CADR</p>
                                <p className="text-sm font-medium text-ink">{wardDetails.air_purifier?.cadr}+ m³/h</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">🪟 Ventilation</p>
                                <p className="text-sm font-medium text-ink">{wardDetails.ventilation_advice}</p>
                              </div>
                            </div>
                          </div>
                        )}
                        ...
                        {wardDetails.recommendations && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">📋 Recommendations</h3>
                              ...
                              {wardDetails.recommendations.map((rec, idx) => (
                                <li key={idx} className={`flex items-start gap-2 p-2 rounded-lg ${
                                  ...
                                  <div>
                                    ...
                                    <span className="text-ink text-sm">{rec.text}</span>
                                  </div>
                                </li>
                              ))}
                            </ul>
                        ...
                        {wardDetails.comparison && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">📊 Rankings & Comparison</h3>
                            <div className="grid grid-cols-2 gap-2">
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Delhi Rank</p>
                                <p className="text-lg font-bold text-ink">#{wardDetails.comparison.rank_in_delhi}</p>
                                <p className="text-xs text-metal">of {summary.totalWards} wards</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Zone Rank</p>
                                <p className="text-lg font-bold text-primary">{wardDetails.comparison.rank_in_zone}</p>
                                <p className="text-xs text-metal">in {selectedWard.zone}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">Percentile</p>
                                <p className="text-lg font-bold text-status-warning">{wardDetails.comparison.percentile}%</p>
                                <p className="text-xs text-metal">worse than</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3 text-center">
                                <p className="text-xs text-metal">vs Delhi Avg</p>
                                ...
                                <p className="text-xs text-metal">Avg: {wardDetails.comparison.delhi_average_aqi}</p>
                              </div>
                            </div>
                            {wardDetails.comparison.similar_wards?.length > 0 && (
                              <div className="mt-2 p-2 bg-canvas rounded-lg">
                                <p className="text-xs text-metal mb-1">Similar AQI Wards:</p>
                                <p className="text-sm text-ink">{wardDetails.comparison.similar_wards.join(', ')}</p>
                              </div>
                            )}
                          </div>
                        )}
                        ...
                        {wardDetails.temporal_data && (
                          <div>
                            <h3 className="text-lg font-semibold text-ink mb-3">📈 Trends & Patterns</h3>
                            <div className="grid grid-cols-2 gap-2">
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">24h Trend</p>
                                <p className={`text-sm font-medium ${
                                  wardDetails.temporal_data.trend_24h === 'increasing' ? 'text-status-danger' :
                                  wardDetails.temporal_data.trend_24h === 'decreasing' ? 'text-status-safe' : 'text-status-warning'
                                }`}>
                              ...
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">7-Day Avg</p>
                                <p className="text-sm font-medium text-ink">{wardDetails.temporal_data.avg_7_day} AQI</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">Peak Hours</p>
                                <p className="text-sm font-medium text-status-danger">{wardDetails.temporal_data.peak_hour}</p>
                              </div>
                              <div className="bg-canvas rounded-lg p-3">
                                <p className="text-xs text-metal mb-1">Best Time</p>
                                <p className="text-sm font-medium text-status-safe">{wardDetails.temporal_data.lowest_hour}</p>
                              </div>
                            </div>
                            <div className="mt-2 p-2 bg-amber-50 border border-amber-200 rounded-lg">
                              <p className="text-xs text-amber-700">🍂 {wardDetails.temporal_data.seasonal_context}</p>
                            </div>
                          </div>
                        )}
                        ...
                        {wardDetails.station_info && (
                          <div className="bg-canvas rounded-lg p-3">
                            <h3 className="text-sm font-semibold text-ink mb-2">📡 Station Information</h3>
                            <div className="grid grid-cols-2 gap-2 text-xs">
                              <div>
                                <span className="text-metal">Type:</span>
                                <span className="text-ink ml-2">{wardDetails.station_info.type}</span>
                              </div>
                              <div>
                                <span className="text-metal">Agency:</span>
                                <span className="text-ink ml-2">{wardDetails.station_info.agency}</span>
                              </div>
                              <div>
                                <span className="text-metal">Stations:</span>
                                <span className="text-ink ml-2">{wardDetails.station_info.station_count}</span>
                              </div>
                              <div>
                                <span className="text-metal">Reliability:</span>
                                <span className="text-ink ml-2">{wardDetails.station_info.data_reliability}%</span>
                              </div>
                            </div>
                          </div>
                        )}
                      ...
                      <p className="text-metal text-center py-4">No details available</p>
                    )}
                  </div>
                </div>
              </motion.div>
        ...
        {selectedWard && (
          ...
          >
            <motion.div
              ...
              className="w-full max-h-[90vh] bg-surface rounded-t-3xl overflow-hidden"
              ...
              <div className="p-6 space-y-5 max-h-[65vh] overflow-y-auto">
                {detailsLoading ? (
                  ...
                  <>
                    {/* Health Impact Cards */}
                    <div>
                      <h3 className="text-base font-semibold text-ink mb-2">🏥 Health Impact</h3>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="bg-orange-50 border border-orange-200 rounded-card p-3">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-xl">🚬</span>
                            <span className="text-orange-600 text-xs">Cigarettes</span>
                          </div>
                          <p className="text-xl font-bold text-ink">{wardDetails.cigarettes_equivalent}</p>
                          <p className="text-xs text-metal">/day breathed</p>
                        </div>
                        
                        <div className="bg-purple-50 border border-purple-200 rounded-card p-3">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-xl">🫁</span>
                            <span className="text-purple-600 text-xs">Lung Age</span>
                          </div>
                          <p className="text-xl font-bold text-ink">+{wardDetails.lung_age_increase}</p>
                          <p className="text-xs text-metal">years added</p>
                        </div>
                        
                        <div className="bg-red-50 border border-red-200 rounded-card p-3">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-xl">🏥</span>
                            <span className="text-red-600 text-xs">Hospital Risk</span>
                          </div>
                          <p className="text-xl font-bold text-ink">{wardDetails.hospital_visit_risk}%</p>
                          <p className="text-xs text-metal">increased</p>
                        </div>
                        
                        <div className="bg-blue-50 border border-blue-200 rounded-card p-3">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="text-xl">❤️</span>
                            <span className="text-blue-600 text-xs">Life Impact</span>
                          </div>
                          <p className="text-xl font-bold text-ink">-{wardDetails.life_expectancy_impact}</p>
                          <p className="text-xs text-metal">years</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {wardDetails.disease_burden && (
                      <div>
                        <h3 className="text-base font-semibold text-ink mb-2">📊 Annual Disease Burden</h3>
                        <div className="grid grid-cols-3 gap-2">
                          <div className="bg-canvas rounded-lg p-2 text-center">
                            <p className="text-[10px] text-metal">Deaths</p>
                            <p className="text-sm font-bold text-status-danger">{wardDetails.disease_burden.premature_deaths_annual}</p>
                          </div>
                          <div className="bg-canvas rounded-lg p-2 text-center">
                            <p className="text-[10px] text-metal">Respiratory</p>
                            <p className="text-sm font-bold text-status-warning">{wardDetails.disease_burden.respiratory_cases}</p>
                          </div>
                          <div className="bg-canvas rounded-lg p-2 text-center">
                            <p className="text-[10px] text-metal">Heart</p>
                            <p className="text-sm font-bold text-pink-500">{wardDetails.disease_burden.cardiovascular_cases}</p>
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    {wardDetails.mask_recommendation && (
                      <div>
                        <h3 className="text-base font-semibold text-ink mb-2">🎯 Quick Actions</h3>
                        <div className="grid grid-cols-2 gap-2">
                          <div className="bg-canvas rounded-lg p-2">
                            <p className="text-[10px] text-metal">😷 Mask</p>
                            <p className="text-xs font-medium text-ink">{wardDetails.mask_recommendation.type}</p>
                          </div>
                          <div className="bg-canvas rounded-lg p-2">
                            <p className="text-[10px] text-metal">🏃 Outdoor Score</p>
                            <p className="text-xs font-medium text-ink">{wardDetails.outdoor_activity_score}/100</p>
                          </div>
                        </div>
                        <div className="bg-canvas rounded-lg p-2 mt-2">
                          <p className="text-[10px] text-metal">⏰ Best Time Outside</p>
                          <p className="text-xs font-medium text-ink">{wardDetails.best_outdoor_time}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {wardDetails.vulnerable_groups && (
                      <div>
                        <h3 className="text-base font-semibold text-ink mb-2">👥 Vulnerable Groups</h3>
                        <div className="space-y-2">
                          {wardDetails.vulnerable_groups.slice(0, 3).map((group, idx) => (
                            <div key={idx} className="flex items-center justify-between p-2 bg-canvas rounded-lg">
                              <div className="flex items-center gap-2">
                                ...
                                <div>
                                  <span className="text-ink text-sm">{group.group}</span>
                                  <p className="text-[10px] text-metal">{group.count?.toLocaleString()} people</p>
                                </div>
                              </div>
                    ...
                    {wardDetails.recommendations && (
                      <div>
                        <h3 className="text-base font-semibold text-ink mb-2">📋 Top Recommendations</h3>
                        <ul className="space-y-1.5">
                          {wardDetails.recommendations.slice(0, 4).map((rec, idx) => (
                            <li key={idx} className={`flex items-start gap-2 p-2 rounded-lg text-xs ${
                              ...
                              <span>{rec.icon}</span>
                              <span className="text-ink">{rec.text}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
                    ...
                    {wardDetails.economic_impact && (
                      <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-orange-200 rounded-lg p-3">
                        <p className="text-xs text-metal mb-1">💰 Annual Economic Impact</p>
                        <p className="text-xl font-bold text-ink">₹{wardDetails.economic_impact.total_cost_lakhs} Lakhs</p>
                        <p className="text-xs text-metal">Healthcare + Productivity Loss</p>
                      </div>
                    )}
                  </>
                ) : (
